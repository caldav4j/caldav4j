 ...
 * @version $Id: CalendarCalDAVReportMethodTest.java 315 2011-03-14 22:34:32Z robipolli@gmail.com $
...
public class CalendarCalDAVReportMethodTest {
	...
	{
		CalendarCalDAVReportMethod method = new CalendarCalDAVReportMethod(path);
