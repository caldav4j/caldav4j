...
public interface TestConstants {
    ...
    public static final String ICS_ALL_DAY_JAN1 = "icalendar/All_Day_NY_JAN1.ics";
    public static final String ICS_ALL_DAY_JAN1_UID = "C68DADAD-37CE-44F7-8A37-52E1D02E29CA";

    public static final String ICS_NORMAL_PACIFIC_1PM = "icalendar/Normal_Pacific_1pm.ics";
    ...
    public static final String ICS_FLOATING_JAN2_7PM = "icalendar/Floating_Jan_2_7pm.ics";
    ...
    public static final String ICS_GOOGLE_DAILY_NY_5PM_PATH = "icalendar/Google_Daily_NY_5pm"+".ics";
    ...
    public static final String ICS_GOOGLE_ALL_DAY_JAN1_PATH = "icalendar/Google_All_Day_NY_JAN1.ics";
    ...
    public static final String ICS_GOOGLE_NORMAL_PACIFIC_1PM_PATH = "icalendar/Google_Normal_Pacific_1pm.ics";
    ...
    public static final String ICS_GOOGLE_FLOATING_JAN2_7PM_PATH = "icalendar/Google_Floating_Jan_2_7pm.ics";

    public static final String ICS_GOOGLE_SINGLE_EVENT_PATH = "icalendar/Google_singleEvent.ics";
    ...
    public static final String ICS_SINGLE_EVENT= "icalendar/singleEvent.ics";
