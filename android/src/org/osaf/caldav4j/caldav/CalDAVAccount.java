...
public class CalDAVAccount {
    ...
    public CalDAVAccount(Context context) {
    ...
    public CalDAVAccount(Context context, String name, String user, String password, String host, String proto,
    ...
    CalDAVAccount(Preferences preferences, String uuid) {
        this.mUuid = uuid;
        refresh(preferences);
    }
    ...
    public void save(Preferences preferences) {
        ...
        if (!preferences.mSharedPreferences.getString("accountUuids", "").contains(mUuid)) {
             ...
             */
            CalDAVAccount[] accounts = preferences.getAccounts();
    ...
    public boolean equals(Object o) {
        if (o instanceof CalDAVAccount) {
            CalDAVAccount a = (CalDAVAccount)o;
