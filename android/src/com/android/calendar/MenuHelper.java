...
import com.android.calendar.caldav.CalDAVCtrlActivity;
...
public class MenuHelper {
    ...
    private static final int MENU_GROUP_CALDAV = 9;
    ...
    public static final int MENU_CALDAV = 12;
    ...
    public static boolean onCreateOptionsMenu(Menu menu) {
        ...
        item = menu.add(MENU_GROUP_CALDAV, MENU_CALDAV, 0, R.string.caldav_ctrl_title);
        return true;
    }
	...
	case MENU_CALDAV: {
            Intent intent = new Intent(Intent.ACTION_VIEW);
            intent.setClass(activity, CalDAVCtrlActivity.class);
            activity.startActivity(intent);
	    return true;
	}
