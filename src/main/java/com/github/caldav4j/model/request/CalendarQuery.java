...
public class CalendarQuery extends OutputsDOMBase implements CalDAVReportRequest {
    ...
    public CalendarQuery(
        ...
        if (properties != null) this.properties.addChildren(properties);
    }
    ...
    public CalendarQuery(
            CompFilter compFilter, CalendarData calendarData, boolean allProp, boolean propName) {
     ...
     *
     * <p>&lt;!ELEMENT calendar-query (DAV:allprop | DAV:propname | DAV:prop)? filter&gt;
     *
