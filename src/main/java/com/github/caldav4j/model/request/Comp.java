...
/**
 * Defines which component types to return. The name value is a calendar component name (e.g.,
 * VEVENT).
 *
 * <pre>
...
public class Comp extends OutputsDOMBase {
    ...
    /**
     * &lt;!ELEMENT comp ((allcomp, (allprop | prop*)) | (comp*, (allprop | prop*)))&gt;
     *
     * <pre>
     * &lt;!ATTLIST comp name CDATA #REQUIRED&gt;
     * &lt;!ELEMENT allcomp EMPTY&gt;
