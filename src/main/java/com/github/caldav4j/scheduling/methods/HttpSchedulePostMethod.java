...
public class HttpSchedulePostMethod extends HttpPostMethod<Calendar> {
    ...
    public HttpSchedulePostMethod(
            URI uri, CalendarRequest calendarRequest, CalendarResourceParser calendarOutputter) {
        super(uri, calendarRequest, calendarOutputter);
    }

    public HttpSchedulePostMethod(
            String uri, CalendarRequest calendarRequest, CalendarResourceParser calendarOutputter) {
        super(uri, calendarRequest, calendarOutputter);
    }
    ...
    protected void addRequestHeaders(CalendarRequest calendarRequest) {
        ...
        Calendar calendar = calendarRequest.getResource();
