...
public class EhCacheResourceCache implements CalDAVResourceCache {
	 ...
	 */
	public synchronized String getHrefForEventUID(String uid) throws com.github.caldav4j.exceptions.CacheException {
		Element e = null;
		try {
			e = uidToHrefCache.get(uid);
		} catch (CacheException ce) {
			throw new com.github.caldav4j.exceptions.CacheException("Problem with the uidToHrefCache", ce);
		}
	 ...
	 */
	public synchronized void removeResource(String href) throws com.github.caldav4j.exceptions.CacheException {
