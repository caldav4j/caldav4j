...
public abstract class DAVMethodFactory<T extends Serializable> {
    ...
    protected final ResourceParser<T> getResourceParser() {
        if (parser == null) {
     ...
     * @throws IOException if error occurred during parsing of parameters
     */
    public HttpCalDAVReportMethod<T> createCalDAVReportMethod(URI uri, CalDAVReportRequest request)
            throws IOException {
     ...
     * @throws IOException if error occurred during parsing of parameters
     */
    public HttpCalDAVReportMethod<T> createCalDAVReportMethod(
     ...
     */
    public HttpCalDAVReportMethod<T> createCalDAVReportMethod(
            String uri, CalDAVReportRequest request) throws IOException {
