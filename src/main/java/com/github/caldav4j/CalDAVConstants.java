...
public interface CalDAVConstants {
    ...
    public static final Namespace NAMESPACE_CALDAV =
            Namespace.getNamespace(NS_QUAL_CALDAV, NS_CALDAV);
    ...
    public static final int DEPTH_INFINITY =
            Integer.MAX_VALUE; // as 1 + properties of all files in sub-directories of the
    ...
    // DavPropertyNames
    public static final DavPropertyName DNAME_CALENDAR_DESCRIPTION =
            DavPropertyName.create(CALDAV_CALENDAR_DESCRIPTION, NAMESPACE_CALDAV);
    public static final DavPropertyName DNAME_CALENDAR_DATA =
            DavPropertyName.create(CALDAV_CALENDAR_DATA, NAMESPACE_CALDAV);
    public static final DavPropertyName DNAME_ACL =
            DavPropertyName.create(CalDAVConstants.DAV_ACL, NAMESPACE_WEBDAV);
    public static final DavPropertyName DNAME_GETETAG =
            DavPropertyName.create(ELEM_GETETAG, NAMESPACE_WEBDAV);
    public static final DavPropertyName DNAME_ALLPROP =
            DavPropertyName.create(ELEM_ALLPROP, NAMESPACE_WEBDAV);
    public static final DavPropertyName DNAME_DISPLAYNAME =
            DavPropertyName.create(DAV_DISPLAYNAME, NAMESPACE_CALDAV);
    // -------------------------------------------------< PropFind Constants >---
