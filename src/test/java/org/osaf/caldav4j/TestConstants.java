...
public interface TestConstants {
    ...
    public static final String ICS_ALL_DAY_JAN1_PATH = ICS_RESOURCE_PATH + "All_Day_NY_JAN1.ics";
    ...
    public static final String ICS_NORMAL_PACIFIC_1PM_PATH = ICS_RESOURCE_PATH + "Normal_Pacific_1pm.ics";
    ...
    public static final String ICS_FLOATING_JAN2_7PM_PATH = ICS_RESOURCE_PATH + "Floating_Jan_2_7pm.ics";
    ...
    public static final String ICS_GOOGLE_DAILY_NY_5PM_PATH = ICS_RESOURCE_PATH + "Google_Daily_NY_5pm.ics";
    ...
    public static final String ICS_GOOGLE_ALL_DAY_JAN1_PATH = ICS_RESOURCE_PATH + "Google_All_Day_NY_JAN1.ics";
    ...
    public static final String ICS_GOOGLE_NORMAL_PACIFIC_1PM_PATH = ICS_RESOURCE_PATH + "Google_Normal_Pacific_1pm.ics";
    ...
    public static final String ICS_GOOGLE_FLOATING_JAN2_7PM_PATH = ICS_RESOURCE_PATH + "Google_Floating_Jan_2_7pm.ics";
    ...
    public static final String ICS_GOOGLE_SINGLE_EVENT = ICS_GOOGLE_SINGLE_EVENT_UID + ".ics";
    public static final String ICS_GOOGLE_SINGLE_EVENT_PATH = ICS_RESOURCE_PATH + "Google_singleEvent.ics";
    
    public static final String ICS_SINGLE_EVENT = "singleEvent.ics";
    public static final String ICS_SINGLE_EVENT_PATH = ICS_RESOURCE_PATH + "singleEvent.ics";
