...
import com.github.caldav4j.methods.MkCalendarTest;
...
public class MkCalendarITCase extends MkCalendarTest {

    public MkCalendarITCase(CaldavCredential credential, CalDavDialect dialect) {
